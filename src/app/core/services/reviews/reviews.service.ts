...
export class ReviewsService {
  ...
  updateAndSumbitReview(reviewId: string, review: string, rating: number): Observable<any> {
    return this._HttpClient.put(`${this.baseUrl}/update-review`, { reviewId, review, rating })
      .pipe(catchError(this.handleError));
  }
